<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="GroupProject.Pages.Register" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="~/App_Themes/Main/register.css" />
...
<body>
    ...
    <div class="transparent-content">
        <form runat="server" class="login-container">
            <span class="company-name">Easy Food Restaurants - Registration</span>
